    ...
    <div class="card card-primary card-outline">
        <div class="card-body">
            <form action="{{ route('reimburse.store') }}" method="POST" id="reimburseForm" enctype="multipart/form-data">
                ...
                <x-adminlte-input-file name="foto" label="Nota (Kosongkan jika tidak ada)" placeholder="Pilih file..." show-file-name
                ...
                <x-adminlte-textarea name="keterangan" label="Keterangan" placeholder="Tuliskan keterangan reimburse Anda di sini..."></x-adminlte-textarea>
