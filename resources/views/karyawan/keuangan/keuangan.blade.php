    ...
    <div class="card-body">
        <x-adminlte-modal id="modalMasuk" title="Tambahkan Histori Keuangan" theme="success" icon="fas fa-clipboard"
            ...
            <form action="{{ route('keuangan.store') }}" method="POST" id="modalMasukForm">
                ...
                <x-adminlte-input name="masuk" label="Uang Masuk" placeholder="Masukkan jumlah..." igroup-size="md"
                    required>
        ...
        <x-adminlte-modal id="modalKeluar" title="Tambahkan Histori Keuangan" theme="success" icon="fas fa-clipboard"
            size='lg'>
            <form action="{{ route('keuangan.store') }}" method="POST" id="modalKeluarForm">
                ...
                <x-adminlte-input name="keluar" label="Uang Keluar" placeholder="Masukkan jumlah..." igroup-size="md"
                    required>
                    <x-slot name="prependSlot">
                        <div class="input-group-text">
                            <i class="fas fa-money-bill"></i>
